package com.bosch.procon.stockmanagement.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("StockManagement");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("StockManagement");
        ...
        config.getMapConfigs().put("com.bosch.procon.stockmanagement.domain.*", initializeDomainMapConfig(jHipsterProperties));
